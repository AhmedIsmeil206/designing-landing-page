  ...
  return (
    <>
      ...
      <div css={proBannerdiv}>
        <div
          css={{ display: "flex", textAlign: "left", flexDirection: "column" }}
        >
          <h2
            css={{
              fontSize: "24px",
          ...
          >
            Join thousands of developers getting personalized insights to
            elevate your front-end and full-stack skills.
          </p>
        </div>
      ...
      <div
        css={{
          padding: "64px 72px",
          background: colors.Main_whiteHover,
          ...
          <div css={testimonialCard}>
            ...
            >
              ...
              >
                ...
                <div css={{ fontSize: "12px", color: colors.darkGrey }}>
